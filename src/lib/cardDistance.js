...
// Kalibracija (2026-09-25): Android tablet, udaljenost merena metrom 65 i 60 cm → 29,2° i 30,2°;
// stari Android telefon, udaljenost procenjena ~55 cm → 33,5°. Uzeto 30° (merenja metrom imaju prednost).
// Uticaj na PD je mali: greška udaljenosti od 10% na 60 cm menja rezultat za ~0,2 mm.
export const VFOV_PRIOR = { phonePortrait: 70, phoneLandscape: 55, desktop: 45, rearPortrait: 39, rearLandscape: 30 };
